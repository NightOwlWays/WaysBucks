...
const Addproduct = () => {
    ...
    return (
        <>
            ...
            <div className="row">
                <div className="col-6">
                <h2 className="mb-5 mx-5">Product</h2>
                    <Form className="mx-5">
                        <div className="mb-4">
                            <input type="text" className="form-control" id="exampleFormControlInput1" style={{backgroundColor: "#f9d9d9", color: "white"}} placeholder="Name Product"/>
                        </div>
                        <div className="mb-4">
                        ...
                        <Button type="submit" className="btn-success col-11 btn-danger mx-auto ">Add Product</Button>
                        </div>
                    </Form>
                </div>
